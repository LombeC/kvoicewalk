...
STARTING_VOICE="/app/example/94.78_0.94_8195.pt"
STEP_LIMIT=20000
...
uv run main.py --target_text "$TARGET_TEXT" --target_audio "$TARGET_AUDIO" --starting_voice "$STARTING_VOICE" --step_limit "$STEP_LIMIT"
